          ...
          <Grid item xs={12} sm={12}>
            <FormControl className={classes.formControl} variant="filled">
              ...
              <Select
                ...
                MenuProps={MenuProps}
              >
                {centralDistricts.map(option => (
                  <MenuItem key={option.value} value={option.value}>
                    <Checkbox
                      checked={
                        this.state.centralDistricts.indexOf(option.value) > -1
                      }
                    />
          ...
          <Grid item xs={12} sm={12}>
            <FormControl className={classes.formControl} variant="filled">
              ...
              <Select
                ...
                MenuProps={MenuProps}
              >
                {easternDistricts.map(option => (
                  <MenuItem key={option.value} value={option.value}>
                    <Checkbox
                      checked={
                        this.state.easternDistricts.indexOf(option.value) > -1
                      }
                    />
                    <ListItemText primary={option.label} />
                  </MenuItem>
          ...
          <Grid item xs={12} sm={12}>
            <FormControl className={classes.formControl} variant="filled">
              ...
              <Select
                ...
                MenuProps={MenuProps}
              >
                {northernDistricts.map(option => (
                  <MenuItem key={option.value} value={option.value}>
                    <Checkbox
                      checked={
                        this.state.northernDistricts.indexOf(option.value) > -1
                      }
                    />
                    <ListItemText primary={option.label} />
                  </MenuItem>
